...
import { Wine, RefreshCw, Clock, AlertTriangle, CheckCircle2, ChefHat } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-[#8D6CE5]/15">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-text-muted">Cocktails, pints, and spirit pours synchronized in real time</p>
          </div>
        </div>
