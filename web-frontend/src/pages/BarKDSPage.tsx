...
import { Wine, Clock, AlertTriangle, CheckCircle2, Loader2, RotateCcw, Layers, Ban, X, Trash2 } from 'lucide-react';
...
export const BarKDSPage: React.FC<BarKDSPageProps> = ({ initialSubTab = 'tickets' }) => {
  ...
  const handleConfirmCleanup = async () => {
    ...
    try {
      ...
      showToast(`Order for "${cleanupModalItem.itemName}" removed from Bar KDS`, 'info');
  ...
  // Flatten active BAR items for board columns (excluding terminal SERVED, CANCELLED, STOCK_OUT)
            ...
            <div>
              ...
              <div className="text-xs text-zinc-600 dark:text-zinc-300 mt-3 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800/50 p-3.5 rounded-xl space-y-1.5">
                <p className="text-[11px] leading-relaxed">
                  • <strong>Already accepted items</strong> (Accepted, Preparing, Ready, Served) remain unaffected and continue through normal bar workflow.
                </p>
                <p className="text-[11px] leading-relaxed">
                  • <strong>All unaccepted orders</strong> for this drink will automatically become <strong>Stock Out (₹0 / Not Charged)</strong>.
                </p>
                <p className="text-[11px] leading-relaxed">
          ...
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl w-full max-w-md p-6 shadow-2xl space-y-4">
            ...
            <div>
              ...
              <div className="text-xs text-zinc-600 dark:text-zinc-300 mt-3 bg-rose-50 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-800/50 p-3.5 rounded-xl space-y-1.5">
                ...
                <p className="text-[11px] leading-relaxed">
                  • This pending order was never accepted and can no longer be poured/prepared since the dining session ended.
                </p>
                <p className="text-[11px] leading-relaxed">
