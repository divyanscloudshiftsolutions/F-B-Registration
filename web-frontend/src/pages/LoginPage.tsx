...
export const LoginPage: React.FC = () => {
 ...
 setIsSubmitting(false);
  ...
  return (
    <div style={{ fontFamily: "'Manrope', sans-serif" }} className="min-h-[100dvh] dark:bg-gradient-to-br dark:from-[#141225] dark:via-[#1A1333] dark:to-[#080612] bg-gradient-to-br from-[#F5F3FA] via-[#FAF9FF] to-[#EDE9FE] flex flex-col justify-center items-center p-3 sm:p-6 lg:p-12 relative overflow-y-auto overflow-x-hidden text-text-main">
