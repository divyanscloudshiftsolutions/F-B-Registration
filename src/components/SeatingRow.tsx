    ...
    <div className="space-y-4 py-4 md:py-6 first:pt-0 border-b border-border-sidebar/30 last:border-b-0 relative">
      ...
      <div className="flex items-center justify-between border-b border-border-sidebar/40 pb-2 px-1">
        <div className="flex items-center gap-2.5">
          <div className="w-2 h-2 rounded-full dark:bg-[#8D6CE5] bg-primary dark:shadow-[0_0_8px_#8D6CE5] shadow-[0_0_8px_rgba(124,58,237,0.5)]" />
        ...
        <span className="px-3 py-0.5 rounded-full dark:bg-[#8D6CE5]/10 bg-primary/10 dark:border-[#8D6CE5]/30 border-primary/20 dark:text-[#8D6CE5] text-primary text-[10px] font-mono font-black">
