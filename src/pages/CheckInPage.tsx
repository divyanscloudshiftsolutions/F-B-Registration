              ...
              <div className="relative rounded-2xl overflow-hidden bg-bg-primary border border-border-main aspect-video flex flex-col items-center justify-center shadow-inner">
                {cameraActive ? (
                  <>
                    ...
                    <div className="absolute w-44 h-44 border-2 border-[#8D6CE5] rounded-3xl z-10 flex items-center justify-center bg-black/10 shadow-[0_0_15px_rgba(212,175,55,0.25)]">
          ...
          {stage === 5 && createdToken && (
            <div className="glass-panel p-8 rounded-3xl border border-emerald-500/30 bg-emerald-500/5 space-y-6 text-center">
              ...
              <button
                ...
                className="px-8 py-3.5 rounded-xl primary-btn text-xs font-black uppercase tracking-wider shadow-xl inline-flex items-center gap-2 cursor-pointer"
              >
